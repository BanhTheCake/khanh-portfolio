...
export default function ProjectTwo_3() {
  return (
    ...
    <div className="flex items-center gap-10 font-UTM text-white">
        <div className="flex-2 flex flex-col gap-5">
     ...
     <div className="flex flex-col items-center  font-UTM text-white py-20">
        ...
        <div className="flex flex-col items-center font-UTM text-white py-10 gap-10">
            <div className="flex gap-10 flex-wrap justify-center">
                {Posters && Posters.map((poster, _) => (
                    ...
                    <img className="flex-1 2xl:h-100 h-80 object-contain " src={poster.src} alt={poster.alt} key={poster.src} />
                      </PhotoView>
                ))}
            </div>
            ...
            <div className="flex flex-col items-center font-UTM text-white pb-10" key={material.src}>
                <div className="flex gap-10 flex-wrap justify-center pb-10">
                    <PhotoView src={material.src}>
                        <img className="flex-1 max-w-200 object-contain " src={material.src} alt={material.alt} />
                    </PhotoView>
                </div>
